...
class MyPanel1 ( wx.Panel ):
	...
	def filllist(self):
		...
		lstdir = self.getMData.AllGuiDir("  where rtrim(Guidir.prgdir,4) > '0000' and ltrim(Guidir.prgdir,4) < '5555' ")
		...
		for dr in lstdir:
			...
			for ifil in os.listdir(idr):
				if ifil.rstrip('.py') not in allprgnm and ifil != '__init__.py' and ifil != '__pycache__':
