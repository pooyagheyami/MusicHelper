...
class MyPanel1 ( wx.Panel ):
    ...
    def __init__(self, parent, filpath, id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.Size(500, 456),
        ...
        #print(self.filpath)
        xmlfd,fdata = Impopen.Importfile(self.filpath[0])
        ...
        self.scorbrd = DS.MyScore(self, wx.ID_ANY, fdata)
        ...
        #self.mytxt = wx.TextCtrl(self, wx.ID_ANY, self.filpath[0], wx.DefaultPosition, wx.DefaultSize, 0)
